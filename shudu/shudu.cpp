...
int main(int argc, char* argv[])
{
    ...
    for (int i = 1; i < argc; i++)
    {
        if (strcmp(argv[i], "-c") == 0)
        {
            ...
            if (i >= argc)
            {
                cerr << "The number of finales to be generated needs to be provided after '-c'." << endl;
                return 1;
            }
        ...
        else if (strcmp(argv[i], "-s") == 0)
        {
            ...
            if (i >= argc)
            {
                cerr << "The path of games file needs to be provided after '-s'." << endl;
                return 1;
            }
            game_path = argv[i];
        }
        else if (strcmp(argv[i], "-n") == 0)
        {
            ...
            if (i >= argc)
            {
                cerr << "The number of games to be generated needs to be provided after '-n'." << endl;
                return 1;
            }
        ...
        else if (strcmp(argv[i], "-m") == 0)
        {
            ...
            if (i >= argc)
            {
                cerr << "The difficulty of games to be generated needs to be provided after '-m'." << endl;
                return 1;
            }
        ...
        else if (strcmp(argv[i], "-r") == 0)
        {
            ...
            if (i >= argc)
            {
                cerr << "The number of blanks in each game to be generated needs to be provided after '-r'." << endl;
                return 1;
            }
            blank_num = atoi(argv[i]);
            if (blank_num < 20 || blank_num > 55)
            {
                cerr << "The number of blanks in each game to be generated is invalid." << endl;
                return 1;
            }
        }
    ...
    Sudoku sudoku(final_num, game_path, game_num, difficulty, blank_num, need_unique);
